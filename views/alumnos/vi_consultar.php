  ...
  <div class="row">
    <div class="col-md-12 col-xs-12">
      ...
      <div class="box box-default">
    	...
    	<form class="search" action="<?= $helper->url($ctl, "buscar", ID_DEFECTO)?>" method="POST">
     		<div class="box-body">
          <div class="form-group col-md-8 col-md-offset-2">
           ...
           <div class="box-footer text-center">
            <button type="submit" class="btn btn-primary" type="submit" title="Consultar">Consultar</button>
          </div>
